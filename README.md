...
- Catch the MMS attachments `.txms.txt`, fetch them and forward it to the blockchain provider.
...
MMS messages can contain `.txms.txt` attachments, which are fetched and forwarded to the blockchain provider.
